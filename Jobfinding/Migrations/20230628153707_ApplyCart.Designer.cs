...
namespace Jobfinding.Migrations
{
    ...
    [Migration("20230628153707_ApplyCart")]
    partial class ApplyCart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobfinding.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Jobfinding.Models.Apply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jobfinding.Models.ApplyCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApplyCartItems");
                });

            modelBuilder.Entity("Jobfinding.Models.Applyitem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FindjobId");

                    b.ToTable("Applyitems");
                });
            ...
            modelBuilder.Entity("Jobfinding.Models.Applyitem", b =>
                {
                    b.HasOne("Jobfinding.Models.Apply", "Apply")
                        .WithMany("applyitems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Jobfinding.Models.ApplicationUser", null)
                        .WithMany()
